...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="<?php echo e(asset('import/assets/vendor/aos/aos.css')); ?>" rel="stylesheet">
...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="<?php echo e(asset('import/assets/img/profile-img.jpg')); ?>" alt="" class="img-fluid rounded-circle">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="<?php echo e(asset('import/assets/img/profile-img.jpg')); ?>" class="img-fluid" alt="">
          </div>
    ...
    <section id="postnotes" class="postnotes section-bg">
      ...
      <div class="table">
          ...
          <div class="table-search">   
              ...
              <div class="relative">
                  <input class="search-input" type="text" name="search" placeholder="Search notes.." value="<?php echo e(request('search')); ?>">
              </div>
          </div>
  ...
  <script src="<?php echo e(asset('import/assets/vendor/aos/aos.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('import/assets/vendor/typed.js/typed.min.js')); ?>"></script>
...
</html><?php /**PATH E:\xampp\htdocs\mypersonalweb\resources\views/homepage.blade.php ENDPATH**/ ?>